...
export default function SearchPage() {
  ...
  const filterAndSortListings = () => {
    ...
    // Price range filter
    if (priceRange.min) {
      filtered = filtered.filter((listing) => listing.price >= Number.parseFloat(priceRange.min))
    }
    if (priceRange.max) {
      filtered = filtered.filter((listing) => listing.price <= Number.parseFloat(priceRange.max))
    }
